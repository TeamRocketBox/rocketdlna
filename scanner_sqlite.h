...
char create_detailTable_sqlite[] = "CREATE TABLE DETAILS ("
					...
					"SIZE INTEGER, "
					"TIMESTAMP INTEGER, "
					"TITLE TEXT COLLATE NATURALSORT, "
					"DURATION TEXT, "
					"BITRATE INTEGER, "
					"SAMPLERATE INTEGER, "
					"CREATOR TEXT COLLATE NATURALSORT, "
					"ARTIST TEXT COLLATE NATURALSORT, "
					"ALBUM TEXT COLLATE NATURALSORT, "
					"GENRE TEXT COLLATE NATURALSORT, "
					"COMMENT TEXT, "
					"CHANNELS INTEGER, "
					"DISC INTEGER, "
					"TRACK INTEGER, "
